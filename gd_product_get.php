...
$pageName = 'gd_product_get';

//從列表頁拿到該筆揪團活動的sid
$sid = isset($_GET['sid']) ? intval($_GET['sid']) : 1;
$sql = "SELECT * FROM `group-add` WHERE sid=? ";
...
<?php include __DIR__. '/__html_head.php' ?>
    ...
    .gpd-area6-attentimgbox:hover .member-card-hide{
        opacity: 1;
    }
    .member-card-info p{
        color: white;
...
<?php include __DIR__. '/__navbar.php' ?>
    ...
    <div class="kv" id="npd-fixedbtn">
        ...
        <svg class="kv-wave-bottom" xmlns="http://www.w3.org/2000/svg">
            ...
            <img src="img/<?= $r['groupClass-name'] ?>-kv.jpg" alt="" class="npd-kv01">
        </svg>
    </div>
    ...
    <div class="npd-area2 webcontainer npd-rwdcontainer">
        ...
        <h1 class="npd-area2-title" style="font-weight: 100;">【揪團】<?= $r['courseName'] ?></h1>
                ...
                <div class="npd-area6-box container-md">
                    ...
                    <div class="npd-area6-boxText row">
                        ...
                        <div class="gpd-area6-attent col-md-10 col-sm-10">
                            ...
                            <div class="gpd-area6-attentimgbox">
                                <figure><img src="img/1-comment-1.jpg" alt=""></figure>

                                <!------- hover出現個人小簡介 --------->
                                <section class="member-card member-card-hide">
                                    <div class="member-card-area">
                                        ...
                                        <div class="member-card-info">
                                            ...
                                            <p >大家好，我是Tiffany！最喜歡的運動是潛水，我的目標是探索各種水上運動！</p>
                                        </div> <!-- member-card-info 結束 -->
                                    </div>
                                </section>  <!-- member-card 個人簡介結束 ------------>


                            </div><!-- gpd-area6-attentimgbox結束 -->
